					...
					for (var i = 0; i < 6; i++) {
						...
						switch (i) {
							...
							case 1:
								...
								break;
							case 2:
								td.textContent = instrutor.nm_especialidade_instrutor;
								dados.appendChild(td);
								break;
							case 3:
								...
								break;
							case 4:
								a.href = 'instrutor-update.php?id=' + instrutor.id_instrutor;
								a.innerText = 'Editar';
								td.appendChild(a);
								dados.appendChild(td);
								break;
							case 5:
								...
								b.addEventListener('click', async function(e) {
									...
									if (r) {
										...
										var retorno = await fetch('/Academia/Dao/InstrutorDao.php', {
											method: 'DELETE',
